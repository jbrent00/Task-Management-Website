...
function TaskBoard ({status, tasks, allTasks, setAllTasks, loading, isManualOrder, isFiltered, selectedTab, projects, tags, members = [], projectMode = false, onCreateTag, onNotify, onOpenDetails}) {
