...
export default function TaskDetailModal({
    ...
    return <div className={styles.backdrop} onMouseDown={(event) => { if (event.target === event.currentTarget) requestClose(); }}>
        <section ref={dialog} className={styles.dialog} role="dialog" aria-modal="true" aria-label={task.title} onKeyDown={(event) => {
            ...
            <div className={styles.content}>
                ...
                {!projectLoading && !projectError && tab === 'details' && <form id={formId} className={styles.form} onSubmit={save}>
