...
function TaskAssignmentFields({ projects = [], tags, projectId, tagIds, onProjectChange, onTagIdsChange, onCreateTag, showProject = true, members = [], assigneeIds = [], onAssigneesChange }) {
